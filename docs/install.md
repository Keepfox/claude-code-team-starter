...
- `examples/` and `.claude/skills/` if you want a stack-specific or workflow-specific memory plus checklist layer for Node, Python, Go, frontend-heavy repos, or internal tools
